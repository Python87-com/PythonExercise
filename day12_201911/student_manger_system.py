...
class StudentManagerController:
    ...
    def order_by_score(self):
        """
        根据成绩，对self.__stu_list进行升序排列（冒泡排序逻辑）
        无返回值，直接在原列表中操作数据（总感觉这样做不好,具体什么原因还不清楚...）
        """
...
class StudentManagerView:
    ...
    def __output_students(self, list_output):
        """
            学生信息遍历
            需要调用以存储的学生列表 self.__manager.stu_list
        :param list_output: 学生列表
        """
